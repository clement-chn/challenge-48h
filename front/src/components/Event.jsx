...
const Event = () => {
  return (
    <Box className="events" sx={{border: '1px solid gray', borderRadius: "15px", padding: '20px', margin: '20px', display: "flex", flexDirection: 'column'}}>
      <Typography variant="h2" component="h2" sx={{fontSize: '2rem'}}>Evénement</Typography>
      ...
      <Button sx={{alignSelf: "self-end"}}>S'inscrire</Button>
    </Box>
  );
}
