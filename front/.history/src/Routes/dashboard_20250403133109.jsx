...
const AdminDashboard = () => {
  ...
  return (
    <Box sx={{ p: 3, backgroundColor: '#1CABE2', minHeight: '100vh' }}> {/* Changement de fond */}
      ...
      <Typography variant="h4" color="primary" sx={{ mb: 3, textAlign: 'center', position: 'absolute', top: 18, right: 500 }}>
