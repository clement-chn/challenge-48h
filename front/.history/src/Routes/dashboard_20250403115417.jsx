...
const AdminDashboard = () => {
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Box sx={{ position: 'absolute', top: 18, right: 16, backgroundColor: 'white', borderRadius: 1, boxShadow: 2, p: 1 }}>
        <Button variant="contained" color="primary" background-color="green" onClick={handleOpen}>
